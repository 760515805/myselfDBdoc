...
//sValidation=nyfjs
//sCaption=Parse file with iFilter ...
//sHint=Parse file with associated iFilter and show results in a textbox
		...
		for(var i in vLines){
			...
			if(iDbPos>=0){
				...
				if(xNyf.exportFile(xSsgFn, xTmpFn)>0){
					...
					textbox({sTitle: ''
						, sDescr: _lc2('Descr', 'Text content extracted from attachment file:')+' '+sSsgName
						, sDefTxt: s
						, bReadonly: true
						, bWordwrap: false
					});
